    ...
    return (
       ...
       <Sidebar/>
         ...
         <div className="message-content">
             <p>Hi Teacher,</p>
             <p>to be able to see submited work you must first selector the work submited  to you and if you donot see the work you want right away please search in the search box</p>
